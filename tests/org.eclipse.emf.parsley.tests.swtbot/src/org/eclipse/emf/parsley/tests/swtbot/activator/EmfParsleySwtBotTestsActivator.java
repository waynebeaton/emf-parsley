 ...
 *******************************************************************************/
package org.eclipse.emf.parsley.tests.swtbot.activator;
...
import org.eclipse.emf.parsley.tests.swtbot.factories.CustomContentProviderLibraryExecutableExtensionFactory;
import org.eclipse.emf.parsley.tests.swtbot.factories.CustomContentProviderLibraryModule;
import org.eclipse.emf.parsley.tests.swtbot.factories.CustomElementsContentProviderLibraryExecutableExtensionFactory;
import org.eclipse.emf.parsley.tests.swtbot.factories.CustomElementsContentProviderLibraryModule;
import org.eclipse.emf.parsley.tests.swtbot.factories.CustomLibraryExecutableExtensionFactory;
import org.eclipse.emf.parsley.tests.swtbot.factories.CustomLibraryModule;
import org.eclipse.emf.parsley.tests.swtbot.factories.resourcelistening.ResourceListeningLibraryExecutableExtensionFactory;
import org.eclipse.emf.parsley.tests.swtbot.factories.resourcelistening.ResourceListeningLibraryModule;
...
public class EmfParsleySwtBotTestsActivator extends AbstractUIPlugin {
	...
	public static File localFile(String filename) throws IOException {
